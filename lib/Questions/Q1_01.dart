...
class Question1Sub1Page extends StatefulWidget {
  const Question1Sub1Page({super.key});

  @override
  State<StatefulWidget> createState() => _Question1Sub1PageState();
}

class _Question1Sub1PageState extends State<Question1Sub1Page> {
  ...
  void initState() {
    super.initState();
    AudioPlayer().play(AssetSource('Voice/Q1_1.mp3'));
  }
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: const Text("今年是西元或民國幾年？", style: bigTextStyle),
            ),
            Padding(
              ...
              child: FractionallySizedBox(
                  ...
                  child: Row(children: [
                    ...
                    const Text(" 年", style: bigTextStyle)
                  ])),
            ),
            Padding(
              padding: EdgeInsets.all(30),
                        ...
                        Expanded(child: ElevatedButton(
                          onPressed: () {
                            if(isNumeric(ageInputController.text)){
                              ...
                              Navigator.pushNamed(context, '/question/1-2');
                            }else{
                              setState(() {
                                isValid = false;
                              });
